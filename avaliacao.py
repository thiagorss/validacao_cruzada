...
class Experimento():
    def __init__(self,folds:List[Fold], 
                    ml_method:MetodoAprendizadoDeMaquina,
    ...
    def macro_f1_avg(self) -> float:
        ...
        for resultado in self.resultados:
            macro_f1_average += resultado.macro_f1
        return macro_f1_average/len(self.resultados)
...
class OtimizacaoObjetivoRandomForest(OtimizacaoObjetivo):
    ...
    def obtem_metodo(self,trial: optuna.Trial)->MetodoAprendizadoDeMaquina:
        ...
        clf_rf = RandomForestClassifier(random_state=2, min_samples_split=min_samples, max_features=max_features, n_estimators=num_arvores)
